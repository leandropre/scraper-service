...
class BaseTest(TestCase):
    ...
    if not os.path.exists('tests/logs/unit_tests.log'):os.mkdir('tests/logs')
    handler = logging.FileHandler('tests/logs/unit_tests.log')
    ...
    def setUp(self):
        ...
        self._logger = logging.LoggerAdapter(logging.getLogger('unit_tests'),
